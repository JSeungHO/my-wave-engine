...
진행상태.md            ← NOW (완료·미완 스냅샷)
    ↓
MyWaveCompany_Generated/docs/   ← HOW (기술 상세)
    ├── ARCHITECTURE.md
    ├── API.md
    ├── CONFIG.md
    └── SHADER.md
...
| 4 | [MyWaveCompany_Generated/README.md](../MyWaveCompany_Generated/README.md) | 실행 방법 |

### B. Cesium / 수면 렌더링 담당

| 순서 | 문서 | 목적 |
|------|------|------|
| 1 | [INTEGRATION.md](../MyWaveCompany_Generated/adapters/cesium/INTEGRATION.md) | Phase 2a/2b, 좌표계, TangentPlane |
| 2 | [ARCHITECTURE.md](../MyWaveCompany_Generated/docs/ARCHITECTURE.md) | core / adapters / demo 레이어 |
| 3 | [API.md](../MyWaveCompany_Generated/docs/API.md) | `GerstnerWave`, `loadWavesConfig` |
| 4 | [CONFIG.md](../MyWaveCompany_Generated/docs/CONFIG.md) | `waves.json`, `scene.json` |
...
| 순서 | 문서 | 목적 |
|------|------|------|
| 1 | [SHADER.md](../MyWaveCompany_Generated/docs/SHADER.md) | uniform, include 규칙 |
...
| 4 | [ARCHITECTURE.md § 확장 포인트](../MyWaveCompany_Generated/docs/ARCHITECTURE.md) | 새 모듈 위치 |
| 5 | **신규** [Configs/obstacles.json](../MyWaveCompany_Generated/Configs/obstacles.json) | 건물·차수벽 footprint |
| 6 | [SCENE_LAYOUT.md](./SCENE_LAYOUT.md) | **물 범위·차수벽 위치** JSON 편집 |
| 7 | [FLOOD.md](../MyWaveCompany_Generated/docs/FLOOD.md) | 2D flow, 마스크, GPU 합성 (스펙 초안) |
...
| 작업 | 명령 / URL |
|------|------------|
| Dev 서버 | `dotnet run -- serve` (또는 `MyWaveCompany_Generated`에서 `npm run dev`) |
| Cesium 메인 | `http://localhost:5173/` (포트는 터미널 확인) |
| Three.js 해변 | `/shore.html` |
| GPU 강제 | 기본 GPU 2b; 평면 디버그 `?material=1` |
| 스모크 테스트 | `node MyWaveCompany_Generated/scripts/smoke-test.mjs <URL>` |
